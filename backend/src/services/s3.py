...
class S3Service:
    ...
    async def wait_object(self, bucket: str, key: str, delay: int = 5, max_attempts: int = 20) -> None:
    ...
    async def get_download_url(self, bucket: str, key: str, expiration: int = 3600) -> str:
    ...
    async def get_upload_url(self, bucket: str, key: str, content_type: str, expiration: int = 3600) -> str:
        return await self.s3_client.generate_presigned_url(
            'put_object',
            Params={
                'Bucket': bucket, 
